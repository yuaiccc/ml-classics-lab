...
const EPOCH_CONFIGS = [
  { label: "Epoch 0 (随机)", reward: "~-1480", color: "#ff5252", noise: 4.0 },
  { label: "Epoch 1 (初学)", reward: "~-195", color: "#ffab40", noise: 1.5 },
  { label: "Epoch 2 (进步)", reward: "~-152", color: "#00e5ff", noise: 0.5 },
  { label: "Epoch 3 (稳定)", reward: "~-147", color: "#00ff88", noise: 0.1 },
];
