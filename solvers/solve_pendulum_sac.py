...
def main() -> None:
    ...
    maybe_record(
        ...
        meta={
            ...
            "tutorial": {
                "problem": "连续动作控制：把一根可 360° 旋转的摆杆甩起来，并稳定在竖直向上的位置。",
                "intuition": "动作不再是“左/右”两个选项，而是一个连续的力矩数值。SAC 用高斯策略直接输出力矩大小，还会自动调节“探索温度”，在试探和利用之间找平衡。",
                "watch": [
                    "摆杆从乱转/下垂，逐渐被甩起并稳定到竖直向上",
                    "Return 是负值，越接近 0 表示控制得越好",
                    "竖直向上(θ≈0)时奖励最高，偏离越多扣得越多",
                ],
                "concepts": [
                    {"term": "连续动作空间", "explain": "动作是实数（力矩），不能像离散那样枚举"},
                    {"term": "高斯策略", "explain": "网络输出动作分布的均值和方差，再采样得到力矩"},
                    {"term": "自动温度 α", "explain": "SAC 自动调节熵正则强度，平衡探索与利用"},
                ],
                "tryThis": "拖时间轴看摆杆从摇晃到立稳的全过程。",
            },
